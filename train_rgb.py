...
from models.YpUnet import UNet
...
def train(loader, num_classes, device, net, optimizer, criterion):
    ...
    for images, masks in tqdm.tqdm(loader):
        ...
        optimizer.zero_grad()
        outputs= net(images)
        # print("outputs'size:{},masks'size:{}".format(outputs.size(), masks.size()))
...
def main():
    outPath = f"{args.results}_{args.model_name}"
