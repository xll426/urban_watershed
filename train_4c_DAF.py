...
def train(loader, num_classes, device, net, optimizer, criterion):
    ...
    for images, masks in tqdm.tqdm(loader):
        ...
        optimizer.zero_grad()
        outputs0, outputs1, outputs2, outputs3, outputs0_2, outputs1_2, outputs2_2, outputs3_2 = net(images)
...
def main():
    seed_everything(69)
    outPath = f"{args.results}_{args.model_name}_4c_UNet_DAF"
...
if __name__ =="__main__":
    ...
    parse.add_argument("--model_name", type=str, default="DAF", help='myUnet, YpUnet, AlbuNet, FPN, UNet , PSPNet')
