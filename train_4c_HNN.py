...
from weight_loss import WeightedBceLoss
from utils.metrics import Metrics
# import segmentation_models_pytorch as smp
from unet256.YpUnet_AG_hnn234 import UNet
...
def main():
    ...
    scheduler = LearningRateWarmUP(optimizer=optimizer, target_iteration=5, target_lr=0.003,
